...
class Payement1 extends StatelessWidget {
  const Payement1({super.key});

  // Navigation logic for class selection
  void _onClassTap(BuildContext context, String className) {
    // Pass the class name to the Payement2 screen
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => Payement2(className: className), // Pass className to Payement2
      ),
    );
  }
